...
dnf5 group install -y @core --exclude=rootfiles --exclude=PackageKit-gstreamer-plugin --setopt=install_weak_deps=false
dnf5 group install -y @multimedia @"sound-and-video" --setopt=install_weak_deps=false
